...
class HawkEye():
    ...
    def main(self, _argv):
        ...
        while True:
            ...
            print((len(self.tracker.tracks)+1)/(len(detections)+1))
            ...
            for track in self.tracker.tracks:
                ...
                cv2.putText(frame, class_name + "-" + label,(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
